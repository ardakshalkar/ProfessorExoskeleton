...
| `skills/` (16 of its 17) | `ProfessorSkills` | unpacked by `python -m exo setup` into `.agents/skills/`, moved here 2026-09-16 |
...
`skills/ainar-records/`, the seventeenth — the rest of `skills/` is the AINAR
set that used to sit under `.agents/skills/`.
