...
const COLLECTIONS = {
    ...
    documents: ["documents.yaml", "documents/*.yaml"],
...
const FIXTURES = {
    enrollments: ["samples/enrollments*.yaml"],
    documents: ["samples/documents*.yaml"],
    submissions: ["samples/submissions*.yaml"],
    item_responses: ["samples/item-responses*.yaml"],
    evaluations: ["samples/evaluations*.yaml"],
    evidence: ["samples/evidence*.yaml"],
    concept_states: ["samples/concept-states*.yaml"],
    capability_states: ["samples/capability-states*.yaml"],
    signals: ["samples/signals*.yaml"],
    interventions: ["samples/interventions*.yaml"],
    events: ["samples/events*.yaml", "records/events*.yaml"],
    action_items: ["samples/action-items*.yaml", "records/action-items*.yaml"],
};

const FORBIDDEN = {
    enrollments: ["records/enrollments*.yaml"],
