...
export declare const DRAFTABLE: {
 ...
 */
export declare const loadDrafts: (directory: string, issues: IssueList) => Drafted;
/** A copy of the bundle with drafted records appended, for validation. */
export declare const mergeDrafts: (bundle: CourseBundle, drafted: Partial<Record<DraftCollection, Record<string, unknown>[]>>) => CourseBundle;
